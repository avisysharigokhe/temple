...
<div class="content-wrapper">
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h4 class="m-0 text-dark">Add About Ugna</h4>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
         ...
         <div class="row">
            <div class="col-12">
               <div class="card custom-card">
                  <div class="card-body">
                     <a href="{{url('/about-ugna')}}"><button class='btn btn-primary pull-right'><i class="fa fa-arrow-left"></i>  Back</button> </a>
                  </div>
               </div>
            </div>
            <div class="col-12">
               <div class="card">
                <form role="form" method="post" enctype="multipart/form-data" action="{{url('/save_about_ugna')}}" class="add_about_ugna_form" >
                  <div class="card-body">
                        {{ csrf_field() }}
                        <!-- text input -->
                        ...
                        <div class="form-group">
                        <label for="start">Write About Ugna</label>  
                        ...
                        <input type="submit" id="save_about_ugna" name="save_about_ugna" class="btn btn-sm btn-primary
                           " >
