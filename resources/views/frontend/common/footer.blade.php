...
<div class="container d-md-flex py-4">
  ...
  <div class="mr-md-auto text-center text-md-left">
    <div class="copyright">
      &copy; Copyright <strong><span>Vidyapati Dham</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
      ...
      Designed by <a href="avisys.in">Avisys Services Pvt Ltd.</a>
    </div>
  </div>
  <div class="social-links text-center text-md-right pt-3 pt-md-0">
    ...
    <a href="https://in.linkedin.com/" target="_blank"  class="linkedin"><i class="bx bxl-linkedin"></i></a>
  </div>
</div>
</footer><!-- End Footer -->